...
public class GetLoansCustomerIntegrationTest {
    ...
    @Test
    public void shouldGetLoansOfUserlIfUserCustomer() {
        ...
        getLoansRequestHeaders.add(Constants.USERNAME_HEADER, "abc");
        getLoansRequestHeaders.add(Constants.PASSWORD_HEADER, "123");
