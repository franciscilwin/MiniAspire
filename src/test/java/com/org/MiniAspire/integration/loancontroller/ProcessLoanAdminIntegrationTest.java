...
public class ProcessLoanAdminIntegrationTest {
    ...
    @Test
    @Order(4)
    public void shouldProcessLoanIfUserIsAdminAndLoanExists() {
        ...
        Assert.assertEquals("Loan processed", response.getBody());
    }
}
