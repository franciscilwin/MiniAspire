...
public class CreateLoanAdminIntegrationTest {
    ...
    @Test
    public void shouldReturnUnauthorizedStatusCodeIfUserIsAdmin() {
        ...
        headers.add(Constants.USERNAME_HEADER, "admin");
        headers.add(Constants.PASSWORD_HEADER, "xyz123");
